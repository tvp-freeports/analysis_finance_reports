    ...
    post {
        always {
            ...
            plot(
                ...
                style: 'line',
                csvSeries: [[file: 'lint_score.dat', label: 'Lint Score', color: 'blue']],
                yaxisMinimum: '0',
                yaxisMaximum: '10'
            )
            ...
            plot(
                ...
                csvSeries: [[file: 'test_score.dat', label: 'Test Coverage', color: 'green']],
                style: 'line',
                yaxisMinimum: '0',
                yaxisMaximum: '100'
            )
            ...
            plot(
                ...
                csvSeries: [[file: 'docs_score.dat', label: 'Docs Coverage', color: 'purple']],
                style: 'line',
                yaxisMinimum: '0',
                yaxisMaximum: '100'
            )
