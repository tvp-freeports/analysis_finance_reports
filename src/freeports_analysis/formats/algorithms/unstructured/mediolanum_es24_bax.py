...
pipelines = {
    "sfdr_classification": Pipeline(
        pdf_extract = PdfExtractSfdrArticleStandard(
            PdfLineSelection.text("Información periódica de los productos financieros a que se refiere el artículo 9"),
            PdfLineSelection.text("Información periódica de los productos financieros a que se refiere el artículo 8"),
            ...
            ) & PdfLineSelection(font='calibri', font_size=(9.9,10.1))
        ),
