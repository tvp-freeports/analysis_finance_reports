...
See {doc}`parallelism` and {doc}`../../../reference/design/parallelism`.
...
({doc}`../../../reference/design/multidocument`): the pages of all the documents are classified per document and then
