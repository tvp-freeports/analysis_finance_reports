...
If you only extract data, none of this concerns you — see {doc}`index`
...
{doc}`../cli/index` has the grammar, the resolution order and the cache; what belongs here is that a
