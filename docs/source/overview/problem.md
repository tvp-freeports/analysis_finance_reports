...
engine's design. They are developed properly in {doc}`../reference/design/index`; here is what they are for.
...
subject of {doc}`trust`, and reading it is part of using the output responsibly.
