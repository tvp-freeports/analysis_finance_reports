...
``tests.python.lines``                     32.0 %   51.5 %    slow  Line coverage of the Python packages, from pytest --cov.
...
``tests.python.freeports_dev.lines``       27.0 %   49.9 %    slow  Line coverage of one named Python package.
