...
| `tests.python.lines` | 51.4 % | 32.0 % | pass |
...
| `tests.python.freeports_dev.lines` | 49.7 % | 27.0 % | pass |
...
tests.rust.lines, docs.rust, lint.rust, grants.keys_online — measured at 8ef6daa2, not at HEAD (b9464518). Run `make ci`.
