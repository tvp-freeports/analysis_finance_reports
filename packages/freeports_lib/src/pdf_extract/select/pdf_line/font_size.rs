...
impl Into<CompoundAtomOperationRes<PositiveLimits>> for SubtractOverlappingPositiveLimitsRes {
    fn into(self) -> CompoundAtomOperationRes<PositiveLimits> {
...
impl Into<CompoundAtomOperationRes<PositiveLimits>> for SubtractSubsetPositiveLimitsRes {
    fn into(self) -> CompoundAtomOperationRes<PositiveLimits> {
        use CompoundAtomOperationRes::*;
        match self {
            Self::One(a) => One(a),
...
impl Into<CompoundAtomOperationRes<PositiveLimits>> for IntersectOverlappingPositiveLimitsRes {
    fn into(self) -> CompoundAtomOperationRes<PositiveLimits> {
        use CompoundAtomOperationRes::*;
        match self {
            Self::One(a) => One(a)
