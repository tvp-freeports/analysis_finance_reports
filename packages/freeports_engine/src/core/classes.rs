...
create_exception!(freeports_engine, ExpectedPdfBlockNotFound, pyo3::exceptions::PyException, "Raised when a required PdfBlock is not found during processing.");
create_exception!(freeports_engine, ExpectedTextBlockNotFound, pyo3::exceptions::PyException, "Raised when a required TextBlock is not found during processing.");
create_exception!(freeports_engine, PageParseFail, pyo3::exceptions::PyException, "Raised when the algorithm is unable to parse a page.");
create_exception!(freeports_engine, LineParseFail, pyo3::exceptions::PyException, "Raised when the algorithm is unable to parse a line.");
create_exception!(freeports_engine, ExtractionFieldFail, pyo3::exceptions::PyException, "Raised when the algorithm is unable to parse a field.");
