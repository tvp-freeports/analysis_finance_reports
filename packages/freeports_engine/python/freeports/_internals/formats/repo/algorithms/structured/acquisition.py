...
from .pipelines import investments as i
from .pipelines import page_classify as p
from freeports._internals.formats.repo.algorithms.pipelines_definition import Pipeline


def get_pipelines(formats_repo_dir: Path, format_name: str):
    ...
    """
    i_pipelines = i.get_pipelines(formats_repo_dir, format_name)
    p_pipelines = p.get_pipelines(formats_repo_dir, format_name)
