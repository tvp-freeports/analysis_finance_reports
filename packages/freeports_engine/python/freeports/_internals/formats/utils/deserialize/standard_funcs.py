...
shim module) are imported directly from ``freeports_engine.core`` here per that same
...
LineParseFail = freeports_engine.core.LineParseFail
...
DeserializeSfdrArticleStandard = freeports_engine.core.DeserializeSfdrArticleStandard
DeserializerPageClassifyStandard = (
    freeports_engine.core.DeserializerPageClassifyStandard
)
DeserializerFundStandard = freeports_engine.core.DeserializerFundStandard
DeserializerManagmentCompanyStandard = (
    freeports_engine.core.DeserializerManagmentCompanyStandard
)
DeserializerInvestmentsManagerFromManco = (
    freeports_engine.core.DeserializerInvestmentsManagerFromManco
)
DeserializerInvestmentsManagerStandard = (
    freeports_engine.core.DeserializerInvestmentsManagerStandard
)
