...
``position.py``) and into ``freeports_engine.core.PdfLineSelection`` (``PdfLineSelection`` used to
...
common`` alias-only shim modules) are imported directly from ``freeports_engine.core`` here per
...
PdfExtractSfdrArticleStandard = freeports_engine.core.PdfExtractSfdrArticleStandard
PdfExtractCurrencyConstant = freeports_engine.core.PdfExtractCurrencyConstant
PdfExtractPageClassifyStandard = freeports_engine.core.PdfExtractPageClassifyStandard
PdfExtractInvestmentsStandard = freeports_engine.core.PdfExtractInvestmentsStandard
PdfExtractAssetsStandard = freeports_engine.core.PdfExtractAssetsStandard
