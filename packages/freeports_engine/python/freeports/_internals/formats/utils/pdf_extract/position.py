...
InputArea = freeports_engine.core.InputArea
CellGeometry = freeports_engine.core.CellGeometry
RowConfig = freeports_engine.core.RowConfig
ColumnConfig = freeports_engine.core.ColumnConfig
TableConfig = freeports_engine.core.TableConfig
get_groups = freeports_engine.core.get_groups
...
def get_table_coordinates(
    ...
    coords = freeports_engine.core.get_table_coordinates(
    ...
    if collapse:
        coords = freeports_engine.core.collapse_table_rows(
