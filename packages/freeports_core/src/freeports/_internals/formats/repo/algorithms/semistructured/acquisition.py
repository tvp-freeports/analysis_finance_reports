...
import pandas as pd
from . import pdf_extract as p
from . import text_filter as t
from . import deserialize as d
from ..pipelines_definition import (
    index_format_pipe,
...
def get_pipelines(
    ...
    pipeline_names = (
        pdf_extract_pipelines_names
        | text_filter_pipelines_names
        | deserialize_pipelines_names
    )
    pipelines = {}
