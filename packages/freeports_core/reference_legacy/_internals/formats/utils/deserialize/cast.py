"""Archived dead code, moved out of `python/freeports/_internals/formats/utils/deserialize/cast.py`
during the maturin-idiomatic restructure session (2026-08-21) — see
...
The 11 functions below were the original (pre-Rust-port) Python bodies for the casting utilities
now implemented in Rust (`src/core/cast.rs`); the live file kept them, renamed with a `_legacy_`
prefix, as dead code pending this move.
"""
...
from freeports._internals.formats.utils.deserialize.cast import normalize_word
