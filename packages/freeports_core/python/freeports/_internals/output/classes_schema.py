...
Bond = _native.Bond
ManagementCompany = _native.ManagementCompany
InvestmentsManager = _native.InvestmentsManager
Fund = _native.Fund
FundSfdrClassification = _native.FundSfdrClassification
FundEsgIndicator = _native.FundEsgIndicator
FundAssets = _native.FundAssets
FundRename = _native.FundRename
FundMerge = _native.FundMerge
