...
def get_formats(formats_repo_dir: Path) -> pd.DataFrame:
    ...
    Notes
    -----
    Thin wrapper over the native Rust port (``freeports._native.core.get_formats``).
    """
    format_names = _native.core.get_formats(formats_repo_dir)
...
def url_to_format(
    ...
    Notes
    -----
    Thin wrapper over the native Rust port (``freeports._native.core.url_to_format``).
    """
    return _native.core.url_to_format(formats_repo_dir, format_names, url)
