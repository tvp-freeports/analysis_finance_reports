...
already-compiled ``List[CompanyMatchInfos]`` directly (calling ``freeports._native.core.CompanyMatchInfos``
...
get_target_companies = _native.core.get_target_companies
deep_normalize_string = _native.core.deep_normalize_string
